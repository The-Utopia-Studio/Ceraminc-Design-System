...
const docsLabels: Record<string, Record<Locale, string>> = {
  ...
  'AI Chat Workspace': { en: 'AI Chat Workspace', ar: 'مساحة عمل محادثة الذكاء الاصطناعي' },
  ...
  Docs: { en: 'Docs', ar: 'المستندات' },
  'Case Study / Portfolio Page': { en: 'Case Study / Portfolio Page', ar: 'صفحة دراسة حالة أو محفظة' },
  'Ceramic Docs Shell Reference': { en: 'Ceramic Docs Shell Reference', ar: 'مرجع هيكل مستندات Ceramic' },
  'Data Table Workspace': { en: 'Data Table Workspace', ar: 'مساحة عمل جدول البيانات' },
  ...
  'Linear-style Product Homepage': { en: 'Linear-style Product Homepage', ar: 'صفحة منتج رئيسية بأسلوب Linear' },
  ...
  'Onboarding / Application Flow': { en: 'Onboarding / Application Flow', ar: 'مسار الانضمام أو التقديم' },
  ...
  'Product App Shell': { en: 'Product App Shell', ar: 'هيكل تطبيق المنتج' },
  'Product Launch Page': { en: 'Product Launch Page', ar: 'صفحة إطلاق المنتج' },
  'Production Examples': { en: 'Production Examples', ar: 'أمثلة الإنتاج' },
  'Resource / Documentation Article': { en: 'Resource / Documentation Article', ar: 'مقال مورد أو توثيق' },
  'RTL Layout': { en: 'RTL Layout', ar: 'تخطيط RTL' },
  'SaaS Dashboard': { en: 'SaaS Dashboard', ar: 'لوحة تحكم SaaS' },
  'Settings Workspace': { en: 'Settings Workspace', ar: 'مساحة عمل الإعدادات' },
  ...
  'Studio / Agency Homepage': { en: 'Studio / Agency Homepage', ar: 'صفحة استوديو أو وكالة رئيسية' },
  'The Utopia Studio Default': { en: 'The Utopia Studio Default', ar: 'ثيم The Utopia Studio الافتراضي' },
  'The Utopia Studio Website Reference': { en: 'The Utopia Studio Website Reference', ar: 'مرجع موقع The Utopia Studio' },
