...
const pageCopy = {
  ...
  ko: {
    eyebrow: '템플릿',
    title: '실행할 수 있는 것에서 시작하세요.',
    intro: 'Ceramic 전체 웹사이트와 모든 경로를 확인한 뒤, CLI로 로컬 복사본을 생성하세요.',
    runnable: '실행 가능한 템플릿',
    pages: '페이지',
    openPreview: '라이브 미리보기 열기',
    copyCommand: '명령어 복사',
    copied: '복사됨',
    included: '포함된 경로',
    source: '소스 계약',
    howTitle: '3단계로 사용하기',
    howBody: 'CLI가 Ceramic import, 페이지 엔트리, 시드 데이터, 템플릿 manifest가 연결된 독립 Vite 프로젝트를 생성합니다.',
    steps: [
      ['미리보기', '적용 전에 전체 사이트, 반응형 동작, 테마 모드, 아랍어를 확인하세요.'],
      ['생성', '새 웹사이트 프로젝트를 만들 디렉토리에서 복사 명령을 실행하세요.'],
      ['커스텀', '시맨틱 토큰, 컴포넌트, 경로 구조를 유지하며 데모 콘텐츠를 교체하세요.'],
    ],
    command: '독립 복사본 생성',
    importTitle: 'Ceramic 패키지 import',
